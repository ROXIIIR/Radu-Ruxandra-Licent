  ...
  <head> <!-- Începutul secțiunii head -->
	...
	<body> <!-- Începutul corpului paginii web -->
		...
		<div class="container"> <!-- Container Bootstrap -->
            ...
            <img src="img/logo.jpg"alt="DILEMMA" style="width: 150px; height: auto;"> <!-- Imaginea ca Brand-ul site-ului -->		      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation"> <!-- Butonul pentru meniul mobil -->
		      ...
		      <div class="collapse navbar-collapse" id="ftco-nav"> <!-- Meniul principal al site-ului -->
		        <ul class="navbar-nav ml-auto mr-md-3"> <!-- Listă pentru elementele de navigare -->
		          ...
		          <li class="nav-item active"><a href="http://localhost:3000/contact.php" class="nav-link">Contact</a></li> <!-- Element de navigare - Contact -->
...
<div class="responsive-container">
    ...
    <div class="row justify-content-center">
      <div class="col-md-6 text-center">
        ...
        <p>Adresa: Strada Exemplu, Nr. 123, Orașul Tau, Cod Poștal 123456</p>
        <i class="fas fa-phone fa-2x mb-3"></i>
        <p>Telefon: +40 123 456 789</p>
        <i class="fas fa-envelope fa-2x mb-3"></i>
        <p>Email: contact@dilemma.com</p>
      </div>
    </div>
  </div>
...
document.getElementById('color-a').addEventListener('click', function() {
  ...
  document.getElementById('background-element').style.backgroundColor = '#c0ebff';
  ...
  document.getElementById('color-name').style.color = '#c0ebff'
...
document.getElementById('color-b').addEventListener('click', function() {
  ...
  document.getElementById('background-element').style.backgroundColor = '#ffc0cb';
  ...
  document.getElementById('color-name').style.color = '#ffc0cb'
})
</script>
	  ...
	  <div class="footer-content"> <!-- Conținutul footer-ului -->
		...
		<div class="footer-social"> <!-- Secțiunea pentru link-uri sociale în footer -->
		  <ul class="social-icons"> <!-- Iconițe pentru rețelele sociale -->
			<li><a href="#"><i class="fab fa-facebook-f"></i></a></li> <!-- Iconiță Facebook -->
			<li><a href="#"><i class="fab fa-instagram"></i></a></li> <!-- Iconiță Instagram -->
            <li><a href="#"><i class="fab fa-whatsapp"></i></a></li> <!-- Iconiță W -->
