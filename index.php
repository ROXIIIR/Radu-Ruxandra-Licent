...
<html lang="en"> <!-- Începutul elementului HTML cu specificarea limbii -->
    ...
    <img src="img/logo.jpg"alt="DILEMMA" style="width: 150px; height: auto;"> <!-- Imaginea ca Brand-ul site-ului -->
		      ...
		      <div class="collapse navbar-collapse" id="ftco-nav"> <!-- Meniul principal al site-ului -->
		        <ul class="navbar-nav ml-auto mr-md-3"> <!-- Listă pentru elementele de navigare -->
		        	<li class="nav-item active"><a href="#" class="nav-link">Home</a></li> <!-- Element de navigare - Acasă -->
		        	<li class="nav-item"><a href="http://localhost:3000/shop.php" class="nav-link">Shop</a></li> <!-- Element de navigare - Magazin -->
		          <li class="nav-item"><a href="http://localhost:3000/contact.php" class="nav-link">Contact</a></li> <!-- Element de navigare - Contact -->
  ...
  <div class="parallax-container"> <!-- Container pentru efectul parallax -->
    <video class="parallax-video" autoplay muted loop> <!-- Element video pentru fundalul parallax -->
        <source src="img/1.mp4" type="video/mp4"> <!-- Sursa video pentru fundalul parallax -->
        Your browser does not support the video tag. <!-- Fallback pentru browserele care nu suportă video -->
    </video> <!-- Sfârșitul elementului video -->
    <div class="text-overlay"> <!-- Suprapunere text pentru parallax -->
		DILEMMA <!-- Textul suprapus -->
	</div> <!-- Sfârșitul divului pentru suprapunerea textului -->
</div> <!-- Sfârșitul containerului pentru efectul parallax -->


 <!--- New Product --> <!-- Comentariu pentru o secțiune de produs nou -->
...
<div class="container"> <!-- Container pentru secțiunea best-seller -->
    <div class="row"> <!-- Rând pentru titlul secțiunii -->
        <div class="col text-center"> <!-- Col pentru centrarea textului -->
            <h2>BEST SELLER</h2> <!-- Titlul secțiunii -->
        </div> <!-- Sfârșitul colului pentru centrarea textului -->
    </div> <!-- Sfârșitul rândului pentru titlul secțiunii -->
</div> <!-- Sfârșitul containerului pentru secțiunea best-seller -->
<br><br> <!-- Linii goale pentru spațiere -->
<div class='product-container'> <!-- Container pentru produsul best-seller -->
	<div class='highlight-window' id='product-img'> <!-- Fereastră pentru imaginea principală a produsului -->
		<img src='img/IMG_2.jpg' alt='Imagine produs'> <!-- Imaginea principală a produsului -->
		<div class='highlight-overlay' id='product-img-overlay'></div> <!-- Suprapunere pentru imaginea principală -->
	</div> <!-- Sfârșitul divului pentru imaginea principală a produsului -->
    <div class='main-window'> <!-- Fereastră principală pentru detalii despre produs -->
        <div class='main-content'> <!-- Conținutul principal al ferestrei -->
            <h2>MUSE COLLECTION </h2> <!-- Titlul produsului -->
            <h1>Corset handmade "The Starry Night"</h1> <!-- Numele produsului -->
            <h3>Elevate your style, elevate your life</h3> <!-- Descrierea produsului -->
            <div class='description' id='product-description'> <!-- Descrierea detaliată a produsului -->
            Corsetul este o piesă de îmbrăcăminte care îmbină eleganța și arta într-o formă unică. Inspirat din celebrul tablou al lui Vincent van Gogh, acest corset aduce în viață senzațiile și emoțiile picturii "The Starry Night".

Cu o atenție deosebită la detalii, corsetul este realizat din materiale de cea mai înaltă calitate, oferind un confort și o durabilitate excepționale. Designul său distinctiv redă cu fidelitate elementele cheie ale tabloului.

Textura fină și finisajele rafinate conferă acestui corset un aspect luxuriant și elegant. Cu o croială impecabilă, acesta accentuează frumusețea formelor feminine, oferind în același timp susținere și confort. Detaliile delicate, precum panglicile, completează designul într-un mod subtil și rafinat.

Fiecare purtare a corsetului The Starry Night este o experiență artistică în sine. Acest corset este o piesă de colecție, destinată să impresioneze și să încânte orice admirator al artei și al modei.
            </div> <!-- Sfârșitul divului pentru descrierea detaliată a produsului -->
		
		<div class='highlight-window-mobile' id='product-img-mobile'>
			<div class='highlight-overlay-mobile' id='product-img-overlay-mobile'></div>
		</div>
		<div class='options'>
        ...
        </div> <!-- Sfârșitul divului pentru conținutul principal al ferestrei -->
    </div> <!-- Sfârșitul divului pentru fereastra principală a produsului -->
</div>
</div> <!-- Sfârșitul containerului pentru produsul best-seller -->
<br><br><br> <!-- Linii goale pentru spațiere -->
...
document.getElementById('color-b').addEventListener('click', function() {
  ...
  document.getElementById('background-element').style.backgroundColor = '#FF80B1';
  ...
  document.getElementById('color-name').style.color = '#FF80B1'
})
</script>
